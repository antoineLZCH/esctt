...
class Comments extends Composer
{
    ...
    public function title(): string
    {
        return sprintf(
            ...
            _nx('%1$s response to &ldquo;%2$s&rdquo;', '%1$s responses to &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'esctt'),
            get_comments_number() === 1 ? _x('One', 'comments title', 'esctt') : number_format_i18n(get_comments_number()),
            get_the_title()
        );
    }
